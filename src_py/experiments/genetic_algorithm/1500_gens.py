...
def _synthetic_data_experiment():
    ...
    ga = GeneticAlgorithm(8, 1500, 2, 2, 90, 70, None)
...
if __name__ == "__main__":
    ...
    exp_id = -1
    with open("src_py/experiments/genetic_algorithm/experiment_1500.txt", "r") as infile, open("src_py/experiments/genetic_algorithm/results_1500.txt", "w") as outfile:
